---
title: "Bio201 Final Project Calorie"
...
high_calorie <- filter(diet_all, Calories < 2500) %>% 
  rename_all(tolower) 
```
...
all_data_wkly_highcal <- inner_join(x = all_data_wkly, y = high_calorie, 
                                  by = c( "participant_id")) 
  
all_data_wkly_highcal$participant_id_week = paste(all_data_wkly_highcal$participant_id,
                                                 all_data_wkly_highcal$study_week, 
                                                 sep="_")  #match with "sv_table"

all_data_wkly_inner <- inner_join(x = all_data_wkly_highcal, y = species_avg_shared, 
...
# save richness data 
write_delim(richness_df_cal, path = "C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/curated_data/richness_df_cal.txt", delim = "\t")
...
# save plot
save_plot(filename = "C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/figures/rich2_cal.pdf",
          plot = rich2,
          nrow = 1, ncol = 2,
...
# save Simpson data 
write_delim(simpson_df_cal, path = "C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/curated_data/simpson_df_cal.txt", delim = "\t")
...
# save plot
save_plot(filename = "C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/figures/simp2_cal.pdf",
          plot = rich2,
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1) 
