...
diet_f15_ASA2_cal <- read_delim("C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/raw_data/diet_f15_ASA2.txt", 
                            delim = "\t", escape_double = FALSE, 
                            trim_ws = TRUE, 
                            col_types = list()) %>%   
  select(Participant_ID,Semester,Calories)

diet_f17_ASA2_cal <- read_delim("C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/raw_data/diet_f17_ASA2.txt", 
                            delim = "\t", escape_double = FALSE, 
                            trim_ws = TRUE, 
                            col_types = list()) %>% 
  select(Participant_ID,Semester,Calories)
  
diet_w17_ASA2_cal <- read_delim("C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/raw_data/diet_w17_ASA2.txt", 
                            delim = "\t", escape_double = FALSE, 
                            trim_ws = TRUE, 
                            col_types = list()) %>% 
  select(Participant_ID,Semester,Calories)

diet_MFP_cal <- read_delim("C:/Users/tina5/OneDrive/桌面/Bio201ThursPM/raw_data/diet_MFP.txt", 
                            delim = "\t", escape_double = FALSE, 
                            trim_ws = TRUE, 
                            col_types = list()) %>% 
  select(Participant_ID,Semester,Calories)
...
adn_res <- adonis(formula = dat_bray ~ study_week * cal_status, 
                  data = sampledf)
...
adn_2 <- adonis(formula = dat_ja ~ study_week * cal_status, 
                  data = sampledf)
