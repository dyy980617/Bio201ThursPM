...
# save richness data 
write_delim(richness_df_cal, path = "~/Documents/Bio201ThursPM/curated_data/richness_df_cal.txt", delim = "\t")
...
# save plot
save_plot(filename = "~/Documents/Bio201ThursPM/figures/rich2_cal.pdf",
          plot = rich2_cal,
          nrow = 1, ncol = 2,
...
# save Simpson data 
write_delim(simpson_df_cal, path = "~/Documents/Bio201ThursPM/curated_data/simpson_df_cal.txt", delim = "\t")
...
# save plot
save_plot(filename = "~/Documents/Bio201ThursPM/figures/simp2_cal.pdf",
          plot = simp2_cal,
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1) 
...
subset_samples(study_week == "week1" | study_week == "week3")%>%
subset_samples(cal_status == "high" | cal_status == "low")
physq_sub
...
save_plot(filename = "~/Documents/Bio201ThursPM/figures/bc_cal.pdf",
          plot = ordplot1,
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1) 
...
ordplot2 <- plot_ordination(physeq = physq_sub, 
                     ...
                     shape = "cal_status")
print(ordplot2)
save_plot(filename = "~/Documents/Bio201ThursPM/figures/ja_cal.pdf",
          plot = ordplot2,
          nrow = 1, ncol = 2,
          base_aspect_ratio = 1.1) 
